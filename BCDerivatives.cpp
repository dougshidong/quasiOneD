    ...
    std::vector <MatrixXd> &ddRoutdWdW)
{
    ...
    // Second Derivative
    double ddc1dr1dr1, ddc1dp1dp1, ddc1dr1dp1, ddc1dp1dr1,
    ...
    // Second Derivative
    double ddeig2dr1dr1, ddeig2dp1dp1, ddeig2dr1dp1, ddeig2dp1dr1;
    double ddeig2dr2dr2, ddeig2dp2dp2, ddeig2dr2dp2, ddeig2dp2dr2;

    double ddeig3dr1dr1, ddeig3dp1dp1, ddeig3dr1dp1, ddeig3dp1dr1;
    double ddeig3dr2dr2, ddeig3dp2dp2, ddeig3dr2dp2, ddeig3dp2dr2;
    ...
    ddR2dp1dr1 = -deig2dr1 + (-p1 + p2) * ddeig2dp1dr1 
    ...
    ddR2dp2dr2 = deig2dr2 
                 + (-p1 + p2 + c1 * r1 * (-u1 + u2)) * ddeig2dp2dr2;
    ...
    ddR3dp1dr1 = -deig3dr1 + (-p1 + p2) * ddeig3dp1dr1 
    ...
    ddR3dp2dr2 = deig3dr2 
                 + (-p1 + p2 + c1 * r1 * (u1 - u2)) * ddeig3dp2dr2;
    ...
    ddr1dtdp1du1 = (-2.0 * dc1dp1 * dp1dtdu1
                   ...
                   + ddR1dp1du1;
    ddr1dtdr2du1 = ddp1dtdu1dr2 / pow(c1, 2) + ddR1du1dr2;
...
//***************
    ...
    if(u[0] < c[0])
    {
        ...
        ddR3dr2dr2 = (p1 - p2 + c1 * r1 * (u1 - u2)) * ddeig3dr2dr2;
        ddR3du2dr2 = -(c1 * r1 * deig3dr2);
        ddR3dp2dr2 = -deig3dr2 + (p1 - p2 + c1 * r1 * (u1 - u2)) * ddeig3dp2dr2;
...
// ***********************************************************************
        ...
        ddRindWdW[1](0, 0) = ddru1dtdr2dr2;
        ddRindWdW[1](1, 1) = ddru1dtdu2du2;
        ddRindWdW[1](2, 2) = ddru1dtdp2dp2;
        ddRindWdW[1](0, 1) = ddru1dtdr2du2;
        ddRindWdW[1](1, 0) = ddru1dtdu2dr2;
        ddRindWdW[1](0, 2) = ddru1dtdr2dp2;
        ddRindWdW[1](2, 0) = ddru1dtdp2dr2;
        ddRindWdW[1](1, 2) = ddru1dtdu2dp2;
        ddRindWdW[1](2, 1) = ddru1dtdp2du2;

        ddRindWdW[1](3, 3) = ddru1dtdr1dr1;
        ddRindWdW[1](4, 4) = ddru1dtdu1du1;
        ddRindWdW[1](5, 5) = ddru1dtdp1dp1;
        ddRindWdW[1](3, 4) = ddru1dtdr1du1;
        ddRindWdW[1](4, 3) = ddru1dtdu1dr1;
        ddRindWdW[1](3, 5) = ddru1dtdr1dp1;
        ddRindWdW[1](5, 3) = ddru1dtdp1dr1;
        ddRindWdW[1](4, 5) = ddru1dtdu1dp1;
        ddRindWdW[1](5, 4) = ddru1dtdp1du1;

        ddRindWdW[2](0, 0) = dde1dtdr2dr2;
        ddRindWdW[2](1, 1) = dde1dtdu2du2;
        ddRindWdW[2](2, 2) = dde1dtdp2dp2;
        ddRindWdW[2](0, 1) = dde1dtdr2du2;
        ddRindWdW[2](1, 0) = dde1dtdu2dr2;
        ddRindWdW[2](0, 2) = dde1dtdr2dp2;
        ddRindWdW[2](2, 0) = dde1dtdp2dr2;
        ddRindWdW[2](1, 2) = dde1dtdu2dp2;
        ddRindWdW[2](2, 1) = dde1dtdp2du2;

        ddRindWdW[2](3, 3) = dde1dtdr1dr1;
        ddRindWdW[2](4, 4) = dde1dtdu1du1;
        ddRindWdW[2](5, 5) = dde1dtdp1dp1;
        ddRindWdW[2](3, 4) = dde1dtdr1du1;
        ddRindWdW[2](4, 3) = dde1dtdu1dr1;
        ddRindWdW[2](3, 5) = dde1dtdr1dp1;
        ddRindWdW[2](5, 3) = dde1dtdp1dr1;
        ddRindWdW[2](4, 5) = dde1dtdu1dp1;
        ddRindWdW[2](5, 4) = dde1dtdp1du1;
        ...
        for(int Ri = 0; Ri < 3; Ri++)
        {
            ...
            ddRoutdWdW[Ri].topLeftCorner(3, 3) = dwpdw.transpose() * temp;
        }
        ...
        for(int Ri = 0; Ri < 3; Ri++)
        {
            ...
            ddRoutdWdW[Ri].bottomRightCorner(3, 3) = dwpdw.transpose() * temp;
        }
        }
